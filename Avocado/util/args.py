...
class ExperimentArgument:
    ...
    def get_args(self):
        ...
        parser.add_argument("--dataset", choices=["chemprot", "citation_intent", "hyperpartisan_news",
                                                  "amazon","bioasq"], required=True, type=str)
        ...
        parser.add_argument("--encoder_class",
                            choices=["bert-base-uncased", "dmis-lab/biobert-base-cased-v1.1",
                                     ...
                                     "allenai/reviews_roberta_base","./posttrain_clean","../posttrain_clean"],
        ...
        parser.add_argument("--warmup_step", default=1, type=int)
        ...
        parser.add_argument('--seed_list', default= [4], nargs='+', type=int)

        parser.add_argument("--mixed_precision", action="store_false")
        parser.add_argument("--lr", default=1e-5, type=float)
        parser.add_argument("--merge_version", action="store_false")
        parser.add_argument("--bert_freeze", action="store_true")
        parser.add_argument("--contrastive", action="store_false")
...
class CorpusArgument:
    ...
    def get_args(self):
        ...
        parser.add_argument("--dataset", choices=["chemprot", "rct-20k", "rct-sample", "citation_intent", "sciie", \
                                                  "ag", "hyperpartisan_news", "imdb", "amazon", "bio_ner", 'pretrain',"bioasq"],
                            required=True,
                            type=str)
